    ...
    client.connect().subscribe({
        onComplete: socket => {
            ...
            socket.requestStream({
                ...
                metadata: String.fromCharCode('accounts.all'.length) + 'accounts.all',
            }).subscribe({
...
},{"../../../../../../../../../../../../usr/local/lib/node_modules/browserify/node_modules/is-buffer/index.js":35,"./RSocketBufferUtils":10,"fbjs/lib/invariant":4}],13:[function(require,module,exports){
/** Copyright (c) Facebook, Inc. and its affiliates.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
